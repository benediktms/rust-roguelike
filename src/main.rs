...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "Slain by a monster, your hero's journey has dome to a premature end.",
        );
        ctx.print_color_centered(
            5,
            WHITE,
        ...
        ctx.print_color_centered(
            ...
            YELLOW,
            BLACK,
            "Will another brave soul rise to meet the challange?",
        );
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "You put on the amulet of Yala and feel it's awesome power",
        );
        ctx.print_color_centered(
            6,
            WHITE,
